...
10 11 12 13 14
**文章作者: [dre](https://dil666555.github.io)**文章链接: [https://dil666555.github.io/2022/06/10/cpp-improved/](https://dil666555.github.io/2022/06/10/cpp-improved/)**版权声明: 本博客所有文章除特别声明外，均采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) 许可协议。转载请注明来源 [dre](https://dil666555.github.io)！[C++](/tags/C/)[学习笔记](/tags/%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/)[上一篇机房预约系统机房预约系统1. 机房预约系统需求1.1 系统简介1.2 身份简介 **学生：**申请使用机房 **教师：**审核学生的预约申请 **管理员：**给学生，老师创建账号  1.3 机房简介 **1号机房：**容量20人 **2号机房：**容量50人 **3号机房：**容量100人  1.4 申请简介 申请记录每周由管理员清空 学生可以预约未来一周内的机房使用，预约的日期为周一到周五，预约是需要选择预约时段（上午，下午） 教师来审核预约  1.5 系统需求登录界面：  学生，老师，管理员，退出  身份验证后进入子菜单：  学生：学号，姓名，密码 老师：教工号，姓名，密码 管理员：姓名，密码  学生具体功能：  申请预约 查看自身预约   查看所有预约  —  查看所有预约信息及预约状态 取消预约  —  成功或审核中都可取消 注销登录  教师具体功能：  查看所有预约 审核预约 注销登录  管理员具体功能：   添加账号  —  添加学生或教师账号，需检测是否重复 查看账号  —  可以选择查看学生或教师全部信息 查看机房  —  查看所有机房的信息 清空预约 注销登录  2. 创建...](/2022/06/11/lab-reservation/)**相关推荐[** 2022-06-14C++面向对象编程c++面向对象编程1. 内存分区模型C＋＋程序在执行时，将内存大方向划分为4个区域  代码区：存放函数体的二进制代码，由操作系统进行管理的  全局区：存放全局变量和静态变量以及常量  ·栈区：由编译器自动分配释放，存放函数的参数值，局部变量等  ·堆区：由程序员分配和释放，若程序员不释放，程序结束时由操作系统回收   1.1 程序运行前在程序编译后，生成了exe可执行程序，未执行该程序前分为两个区域 代码区： ​	存放CPU 执行的机器指令 ​	代码区是共享的，共享的目的是对于频繁被执行的程序，只需要在内存中有一份代码即可，代码区是只读的，使其只读的原因是防止程序意外地修改了它的指令 全局区： ​	全局变量和静态变量存放在此. ​	全局区还包含了常量区，字符串常量和其他常量（const修饰的变量）也存放在此. ​	该区域的数据在程序结束后由操作系统释放. 1.2 程序运行后栈区： 由编译器自动释分配释放，存放函数的参数值，局部变量等； 注意：不要返回局部变量的地址，栈区开辟的地址由编译器自动释放; 123456789int* fuct(){	int a=10;    r...](/2022/06/14/cpp-oop/)[** 2022-06-11机房预约系统机房预约系统1. 机房预约系统需求1.1 系统简介1.2 身份简介 **学生：**申请使用机房 **教师：**审核学生的预约申请 **管理员：**给学生，老师创建账号  1.3 机房简介 **1号机房：**容量20人 **2号机房：**容量50人 **3号机房：**容量100人  1.4 申请简介 申请记录每周由管理员清空 学生可以预约未来一周内的机房使用，预约的日期为周一到周五，预约是需要选择预约时段（上午，下午） 教师来审核预约  1.5 系统需求登录界面：  学生，老师，管理员，退出  身份验证后进入子菜单：  学生：学号，姓名，密码 老师：教工号，姓名，密码 管理员：姓名，密码  学生具体功能：  申请预约 查看自身预约   查看所有预约  —  查看所有预约信息及预约状态 取消预约  —  成功或审核中都可取消 注销登录  教师具体功能：  查看所有预约 审核预约 注销登录  管理员具体功能：   添加账号  —  添加学生或教师账号，需检测是否重复 查看账号  —  可以选择查看学生或教师全部信息 查看机房  —  查看所有机房的信息 清空预约 注销登录  2. 创建...](/2022/06/11/lab-reservation/)[** 2022-06-12职工管理系统职工管理系统1. 管理系统需求职工管理系统可以用来管理公司所有员工的信息 目标：使用c++实现一个基于多态的职工管理系统 公司职工分为三类：普通员工，经理，老板，显示信息时需要显示职工编号，职工姓名，职工岗位，以及职责  普通员工职责：完成经理交给的任务  经理职责：完成老板交给的任务，并下发任务给员工  老板职责：管理公司所有事物   管理系统需要实现的功能如下：  退出管理程序：退出当前管理系统  增加职工信息：实现批量添加职工功能，将信息录入到文件中，职工信息为：职工编号，姓名，部门编号  显示职工信息：显示公司内部所有职工信息  删除离职职工：按照编号删除指定的职工  修改职工信息：按照编号修改职工个人信息  查找职工信息：按照职工编号过着职工的姓名进行查找相关的人员信息  按照编号排序：按照职工编号，进行排序，排序规则由用户指定  清空所有文档：清空文件中记录的所有职工信息（清空前需要再次确定，防止误删）   2. 创建项目3. 创建管理类管理类负责内容如下：  与用户的沟通菜单界面 对职工更删改查的操作 与文件的读写交互  3.1 创建文件3.2 头文件实现12345...](/2022/06/12/staff-management/)![avatar](/images/profile.jpg)dredre 的博客[文章4](/archives/)[标签2](/tags/)[分类1](/categories/)[**Follow Me](https://github.com/dil666555)[**](https://github.com/dil666555)**公告This is my Blog**目录

1. [1. c++提高编程](#c-%E6%8F%90%E9%AB%98%E7%BC%96%E7%A8%8B)

  1. [1.1. 1.模板](#1-%E6%A8%A1%E6%9D%BF)

    1. [1.1.1. 1.1 模板的概念](#1-1-%E6%A8%A1%E6%9D%BF%E7%9A%84%E6%A6%82%E5%BF%B5)
    2. [1.1.2. 1.2 函数模板](#1-2-%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF)

      1. [1.1.2.1. 1.2.1 函数模板语法](#1-2-1-%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF%E8%AF%AD%E6%B3%95)
      2. [1.1.2.2. 1.2.2 函数模板注意事项](#1-2-2-%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)
      3. [1.1.2.3. 1.2.3 函数模板案例](#1-2-3-%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF%E6%A1%88%E4%BE%8B)
      4. [1.1.2.4. 1.2.4 普通函数和函数模板的区别](#1-2-4-%E6%99%AE%E9%80%9A%E5%87%BD%E6%95%B0%E5%92%8C%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF%E7%9A%84%E5%8C%BA%E5%88%AB)
      5. [1.1.2.5. 1.2.5 普通函数和函数模板的调用规则](#1-2-5-%E6%99%AE%E9%80%9A%E5%87%BD%E6%95%B0%E5%92%8C%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF%E7%9A%84%E8%B0%83%E7%94%A8%E8%A7%84%E5%88%99)
      6. [1.1.2.6. 1.2.6 模板的局限性](#1-2-6-%E6%A8%A1%E6%9D%BF%E7%9A%84%E5%B1%80%E9%99%90%E6%80%A7)
    3. [1.1.3. 1.3 类模板](#1-3-%E7%B1%BB%E6%A8%A1%E6%9D%BF)

      1. [1.1.3.1. 1.3.1 类模板语法](#1-3-1-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E8%AF%AD%E6%B3%95)
      2. [1.1.3.2. 1.3.2 类模板和函数模板的区别](#1-3-2-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E5%92%8C%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF%E7%9A%84%E5%8C%BA%E5%88%AB)
      3. [1.1.3.3. 1.3.3 类模板中的成员函数创建时机](#1-3-3-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E4%B8%AD%E7%9A%84%E6%88%90%E5%91%98%E5%87%BD%E6%95%B0%E5%88%9B%E5%BB%BA%E6%97%B6%E6%9C%BA)
      4. [1.1.3.4. 1.3.4 类模板做函数参数](#1-3-4-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E5%81%9A%E5%87%BD%E6%95%B0%E5%8F%82%E6%95%B0)
      5. [1.1.3.5. 1.3.5 类模板与继承](#1-3-5-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E4%B8%8E%E7%BB%A7%E6%89%BF)
      6. [1.1.3.6. 1.3.6 类模板中的成员函数类外实现](#1-3-6-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E4%B8%AD%E7%9A%84%E6%88%90%E5%91%98%E5%87%BD%E6%95%B0%E7%B1%BB%E5%A4%96%E5%AE%9E%E7%8E%B0)
      7. [1.1.3.7. 1.3.7 类模板分文件编写](#1-3-7-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E5%88%86%E6%96%87%E4%BB%B6%E7%BC%96%E5%86%99)
      8. [1.1.3.8. 1.3.8 类模板与友元](#1-3-8-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E4%B8%8E%E5%8F%8B%E5%85%83)
      9. [1.1.3.9. 1.3.9 类模板案例](#1-3-9-%E7%B1%BB%E6%A8%A1%E6%9D%BF%E6%A1%88%E4%BE%8B)
  2. [1.2. 2. STL初识](#2-STL%E5%88%9D%E8%AF%86)

    1. [1.2.1. 2.1 STL的诞生](#2-1-STL%E7%9A%84%E8%AF%9E%E7%94%9F)
    2. [1.2.2. 2.2 STL基本概念](#2-2-STL%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
    3. [1.2.3. 2.3 STL六大组件](#2-3-STL%E5%85%AD%E5%A4%A7%E7%BB%84%E4%BB%B6)
    4. [1.2.4. 2.4 STL 中容器，算法，迭代器](#2-4-STL-%E4%B8%AD%E5%AE%B9%E5%99%A8%EF%BC%8C%E7%AE%97%E6%B3%95%EF%BC%8C%E8%BF%AD%E4%BB%A3%E5%99%A8)
    5. [1.2.5. 2.5 容器算法迭代器常识](#2-5-%E5%AE%B9%E5%99%A8%E7%AE%97%E6%B3%95%E8%BF%AD%E4%BB%A3%E5%99%A8%E5%B8%B8%E8%AF%86)

      1. [1.2.5.1. 2.5.1 vector存放内置数据类型](#2-5-1-vector%E5%AD%98%E6%94%BE%E5%86%85%E7%BD%AE%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B)
      2. [1.2.5.2. 2.5.2 vector存放自定义数据类型](#2-5-2-vector%E5%AD%98%E6%94%BE%E8%87%AA%E5%AE%9A%E4%B9%89%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B)
      3. [1.2.5.3. 2.5.3 vector容器嵌套容器](#2-5-3-vector%E5%AE%B9%E5%99%A8%E5%B5%8C%E5%A5%97%E5%AE%B9%E5%99%A8)
  3. [1.3. 3. STL常用容器](#3-STL%E5%B8%B8%E7%94%A8%E5%AE%B9%E5%99%A8)

    1. [1.3.1. 3.1 string容器](#3-1-string%E5%AE%B9%E5%99%A8)

      1. [1.3.1.1. 3.1.1 string基本概念](#3-1-1-string%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
      2. [1.3.1.2. 3.1.2 string的构造函数](#3-1-2-string%E7%9A%84%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0)
      3. [1.3.1.3. 3.1.3 string赋值操作](#3-1-3-string%E8%B5%8B%E5%80%BC%E6%93%8D%E4%BD%9C)
      4. [1.3.1.4. 3.1.4 string字符串拼接](#3-1-4-string%E5%AD%97%E7%AC%A6%E4%B8%B2%E6%8B%BC%E6%8E%A5)
      5. [1.3.1.5. 3.1.5 string查找和替换](#3-1-5-string%E6%9F%A5%E6%89%BE%E5%92%8C%E6%9B%BF%E6%8D%A2)
      6. [1.3.1.6. 3.1.6 string的字符串比较](#3-1-6-string%E7%9A%84%E5%AD%97%E7%AC%A6%E4%B8%B2%E6%AF%94%E8%BE%83)
      7. [1.3.1.7. 3.1.7 string字符存取](#3-1-7-string%E5%AD%97%E7%AC%A6%E5%AD%98%E5%8F%96)
      8. [1.3.1.8. 3.1.8 string插入和删除](#3-1-8-string%E6%8F%92%E5%85%A5%E5%92%8C%E5%88%A0%E9%99%A4)
      9. [1.3.1.9. 3.1.9 string子串获取](#3-1-9-string%E5%AD%90%E4%B8%B2%E8%8E%B7%E5%8F%96)
    2. [1.3.2. 3.2 vector容器](#3-2-vector%E5%AE%B9%E5%99%A8)

      1. [1.3.2.1. 3.2.1 vector容器基本概念](#3-2-1-vector%E5%AE%B9%E5%99%A8%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
      2. [1.3.2.2. 3.2.2 vector容器的构造函数](#3-2-2-vector%E5%AE%B9%E5%99%A8%E7%9A%84%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0)
      3. [1.3.2.3. 3.2.3 vector容器赋值操作](#3-2-3-vector%E5%AE%B9%E5%99%A8%E8%B5%8B%E5%80%BC%E6%93%8D%E4%BD%9C)
      4. [1.3.2.4. 3.2.4 vector容量和大小](#3-2-4-vector%E5%AE%B9%E9%87%8F%E5%92%8C%E5%A4%A7%E5%B0%8F)
      5. [1.3.2.5. 3.2.5 vector插入和删除](#3-2-5-vector%E6%8F%92%E5%85%A5%E5%92%8C%E5%88%A0%E9%99%A4)
      6. [1.3.2.6. 3.2.6 vector数据存取](#3-2-6-vector%E6%95%B0%E6%8D%AE%E5%AD%98%E5%8F%96)
      7. [1.3.2.7. 3.2.7 vector互换容器](#3-2-7-vector%E4%BA%92%E6%8D%A2%E5%AE%B9%E5%99%A8)
      8. [1.3.2.8. 3.2.8 vector预留空间](#3-2-8-vector%E9%A2%84%E7%95%99%E7%A9%BA%E9%97%B4)
    3. [1.3.3. 3.3 deque容器](#3-3-deque%E5%AE%B9%E5%99%A8)

      1. [1.3.3.1. 3.3.1 deque容器基本概念](#3-3-1-deque%E5%AE%B9%E5%99%A8%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
      2. [1.3.3.2. 3.2.2 deque构造函数](#3-2-2-deque%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0)
      3. [1.3.3.3. 3.3.3 deque赋值操作](#3-3-3-deque%E8%B5%8B%E5%80%BC%E6%93%8D%E4%BD%9C)
      4. [1.3.3.4. 3.3.4 deque大小操作](#3-3-4-deque%E5%A4%A7%E5%B0%8F%E6%93%8D%E4%BD%9C)
      5. [1.3.3.5. 3.3.5 deque容器的插入和删除](#3-3-5-deque%E5%AE%B9%E5%99%A8%E7%9A%84%E6%8F%92%E5%85%A5%E5%92%8C%E5%88%A0%E9%99%A4)
      6. [1.3.3.6. 3.3.6 deque数据存取](#3-3-6-deque%E6%95%B0%E6%8D%AE%E5%AD%98%E5%8F%96)
      7. [1.3.3.7. 3.3.7 deque容器排序操作](#3-3-7-deque%E5%AE%B9%E5%99%A8%E6%8E%92%E5%BA%8F%E6%93%8D%E4%BD%9C)
    4. [1.3.4. 3.4 案例评委打分](#3-4-%E6%A1%88%E4%BE%8B%E8%AF%84%E5%A7%94%E6%89%93%E5%88%86)

      1. [1.3.4.1. 3.4.1 案例描述](#3-4-1-%E6%A1%88%E4%BE%8B%E6%8F%8F%E8%BF%B0)
      2. [1.3.4.2. 3.4.2 实现步骤](#3-4-2-%E5%AE%9E%E7%8E%B0%E6%AD%A5%E9%AA%A4)
    5. [1.3.5. 3.5 stack容器](#3-5-stack%E5%AE%B9%E5%99%A8)

      1. [1.3.5.1. 3.5.1 stack常用接口](#3-5-1-stack%E5%B8%B8%E7%94%A8%E6%8E%A5%E5%8F%A3)
    6. [1.3.6. 3.6 queue容器](#3-6-queue%E5%AE%B9%E5%99%A8)

      1. [1.3.6.1. 3.6.1 queue容器的基本概念](#3-6-1-queue%E5%AE%B9%E5%99%A8%E7%9A%84%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
      2. [1.3.6.2. 3.6.2 queue常用接口](#3-6-2-queue%E5%B8%B8%E7%94%A8%E6%8E%A5%E5%8F%A3)
    7. [1.3.7. 3.7 list容器](#3-7-list%E5%AE%B9%E5%99%A8)

      1. [1.3.7.1. 3.7.1 list基本概念](#3-7-1-list%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
      2. [1.3.7.2. 3.7.2 list构造函数](#3-7-2-list%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0)
      3. [1.3.7.3. 3.7.3 list赋值与交换](#3-7-3-list%E8%B5%8B%E5%80%BC%E4%B8%8E%E4%BA%A4%E6%8D%A2)
      4. [1.3.7.4. 3.7.4 list大小操作](#3-7-4-list%E5%A4%A7%E5%B0%8F%E6%93%8D%E4%BD%9C)
      5. [1.3.7.5. 3.7.5 list 插入与删除](#3-7-5-list-%E6%8F%92%E5%85%A5%E4%B8%8E%E5%88%A0%E9%99%A4)
      6. [1.3.7.6. 3.7.6 list数据存取](#3-7-6-list%E6%95%B0%E6%8D%AE%E5%AD%98%E5%8F%96)
      7. [1.3.7.7. 3.7.7 list反转和排序](#3-7-7-list%E5%8F%8D%E8%BD%AC%E5%92%8C%E6%8E%92%E5%BA%8F)
      8. [1.3.7.8. 3.7.8 排序案例](#3-7-8-%E6%8E%92%E5%BA%8F%E6%A1%88%E4%BE%8B)
    8. [1.3.8. 3.8 set/multiset 容器](#3-8-set-multiset-%E5%AE%B9%E5%99%A8)

      1. [1.3.8.1. 3.8.1 set基本概念](#3-8-1-set%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
      2. [1.3.8.2. 3.8.2 set构造和赋值](#3-8-2-set%E6%9E%84%E9%80%A0%E5%92%8C%E8%B5%8B%E5%80%BC)
      3. [1.3.8.3. 3.8.3 set大小和交换](#3-8-3-set%E5%A4%A7%E5%B0%8F%E5%92%8C%E4%BA%A4%E6%8D%A2)
      4. [1.3.8.4. 3.8.4 set插入和删除](#3-8-4-set%E6%8F%92%E5%85%A5%E5%92%8C%E5%88%A0%E9%99%A4)
      5. [1.3.8.5. 3.8.5 set查找和统计](#3-8-5-set%E6%9F%A5%E6%89%BE%E5%92%8C%E7%BB%9F%E8%AE%A1)
      6. [1.3.8.6. 3.8.6 set和multiset区别](#3-8-6-set%E5%92%8Cmultiset%E5%8C%BA%E5%88%AB)
      7. [1.3.8.7. 3.8.7 pair对组创建](#3-8-7-pair%E5%AF%B9%E7%BB%84%E5%88%9B%E5%BB%BA)
      8. [1.3.8.8. 3.8.8 set容器排序](#3-8-8-set%E5%AE%B9%E5%99%A8%E6%8E%92%E5%BA%8F)
    9. [1.3.9. 3.9 map/multimap容器](#3-9-map-multimap%E5%AE%B9%E5%99%A8)

      1. [1.3.9.1. 3.9.1 map基本概念](#3-9-1-map%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5)
      2. [1.3.9.2. 3.9.2 map构造和赋值](#3-9-2-map%E6%9E%84%E9%80%A0%E5%92%8C%E8%B5%8B%E5%80%BC)
      3. [1.3.9.3. 3.9.3 map大小和交换](#3-9-3-map%E5%A4%A7%E5%B0%8F%E5%92%8C%E4%BA%A4%E6%8D%A2)
      4. [1.3.9.4. 3.9.4 map插入和删除](#3-9-4-map%E6%8F%92%E5%85%A5%E5%92%8C%E5%88%A0%E9%99%A4)
      5. [1.3.9.5. 3.9.5 map查找和统计](#3-9-5-map%E6%9F%A5%E6%89%BE%E5%92%8C%E7%BB%9F%E8%AE%A1)
      6. [1.3.9.6. 3.9.6 map容器排序](#3-9-6-map%E5%AE%B9%E5%99%A8%E6%8E%92%E5%BA%8F)
    10. [1.3.10. 3.10 案例-员工分组](#3-10-%E6%A1%88%E4%BE%8B-%E5%91%98%E5%B7%A5%E5%88%86%E7%BB%84)

      1. [1.3.10.1. 3.10.1 案例描述](#3-10-1-%E6%A1%88%E4%BE%8B%E6%8F%8F%E8%BF%B0)
      2. [1.3.10.2. 3.10.2 创建步骤](#3-10-2-%E5%88%9B%E5%BB%BA%E6%AD%A5%E9%AA%A4)
  4. [1.4. 4 STL-函数对象](#4-STL-%E5%87%BD%E6%95%B0%E5%AF%B9%E8%B1%A1)

    1. [1.4.1. 4.1 函数对象](#4-1-%E5%87%BD%E6%95%B0%E5%AF%B9%E8%B1%A1)

      1. [1.4.1.1. 4.1.1 函数对象概念](#4-1-1-%E5%87%BD%E6%95%B0%E5%AF%B9%E8%B1%A1%E6%A6%82%E5%BF%B5)
      2. [1.4.1.2. 4.1.2 函数对象使用](#4-1-2-%E5%87%BD%E6%95%B0%E5%AF%B9%E8%B1%A1%E4%BD%BF%E7%94%A8)
    2. [1.4.2. 4.2 谓词（pred）](#4-2-%E8%B0%93%E8%AF%8D%EF%BC%88pred%EF%BC%89)

      1. [1.4.2.1. 4.2.1 谓词概念](#4-2-1-%E8%B0%93%E8%AF%8D%E6%A6%82%E5%BF%B5)
      2. [1.4.2.2. 4.2.2 一元谓词](#4-2-2-%E4%B8%80%E5%85%83%E8%B0%93%E8%AF%8D)
      3. [1.4.2.3. 4.2.3 二元谓词](#4-2-3-%E4%BA%8C%E5%85%83%E8%B0%93%E8%AF%8D)
    3. [1.4.3. 4.3 内建函数对象](#4-3-%E5%86%85%E5%BB%BA%E5%87%BD%E6%95%B0%E5%AF%B9%E8%B1%A1)

      1. [1.4.3.1. 4.3.1 内建函数对象意义](#4-3-1-%E5%86%85%E5%BB%BA%E5%87%BD%E6%95%B0%E5%AF%B9%E8%B1%A1%E6%84%8F%E4%B9%89)
      2. [1.4.3.2. 4.3.2 算数仿函数](#4-3-2-%E7%AE%97%E6%95%B0%E4%BB%BF%E5%87%BD%E6%95%B0)
      3. [1.4.3.3. 4.3.3 关系仿函数](#4-3-3-%E5%85%B3%E7%B3%BB%E4%BB%BF%E5%87%BD%E6%95%B0)
      4. [1.4.3.4. 4.3.4 逻辑仿函数](#4-3-4-%E9%80%BB%E8%BE%91%E4%BB%BF%E5%87%BD%E6%95%B0)
  5. [1.5. 5 STL-常用的算法](#5-STL-%E5%B8%B8%E7%94%A8%E7%9A%84%E7%AE%97%E6%B3%95)

    1. [1.5.1. 5.1 常用遍历算法](#5-1-%E5%B8%B8%E7%94%A8%E9%81%8D%E5%8E%86%E7%AE%97%E6%B3%95)

      1. [1.5.1.1. 5.1.1 for_each](#5-1-1-for-each)
      2. [1.5.1.2. 5.1.2 transform](#5-1-2-transform)
    2. [1.5.2. 5.2 常用的查找算法](#5-2-%E5%B8%B8%E7%94%A8%E7%9A%84%E6%9F%A5%E6%89%BE%E7%AE%97%E6%B3%95)

      1. [1.5.2.1. 5.2.1 find](#5-2-1-find)
      2. [1.5.2.2. 5.2.2 find_if](#5-2-2-find-if)
      3. [1.5.2.3. 5.2.3 adjacent_find](#5-2-3-adjacent-find)
      4. [1.5.2.4. 5.2.4 binary_search](#5-2-4-binary-search)
      5. [1.5.2.5. 5.2.5 count](#5-2-5-count)
      6. [1.5.2.6. 5.2.6 count_if](#5-2-6-count-if)
    3. [1.5.3. 5.3 常用的排序算法](#5-3-%E5%B8%B8%E7%94%A8%E7%9A%84%E6%8E%92%E5%BA%8F%E7%AE%97%E6%B3%95)

      1. [1.5.3.1. 5.3.1 sort](#5-3-1-sort)
      2. [1.5.3.2. 5.3.2 random_shuffle](#5-3-2-random-shuffle)
      3. [1.5.3.3. 5.3.3 merge](#5-3-3-merge)
      4. [1.5.3.4. 5.2.4 reverse](#5-2-4-reverse)
    4. [1.5.4. 5.4 常用的拷贝和替换算法](#5-4-%E5%B8%B8%E7%94%A8%E7%9A%84%E6%8B%B7%E8%B4%9D%E5%92%8C%E6%9B%BF%E6%8D%A2%E7%AE%97%E6%B3%95)

      1. [1.5.4.1. 5.4.1 copy](#5-4-1-copy)
      2. [1.5.4.2. 5.4.2 replace](#5-4-2-replace)
      3. [1.5.4.3. 5.4.3 replace_if](#5-4-3-replace-if)
      4. [1.5.4.4. 5.4.4 swap](#5-4-4-swap)
      5. [1.5.4.5. 5.5 常用算数生成算法](#5-5-%E5%B8%B8%E7%94%A8%E7%AE%97%E6%95%B0%E7%94%9F%E6%88%90%E7%AE%97%E6%B3%95)
      6. [1.5.4.6. 5.5.1 accumulate](#5-5-1-accumulate)
      7. [1.5.4.7. 5.5.2 fill](#5-5-2-fill)
    5. [1.5.5. 5.6 常用的集合算法](#5-6-%E5%B8%B8%E7%94%A8%E7%9A%84%E9%9B%86%E5%90%88%E7%AE%97%E6%B3%95)

      1. [1.5.5.1. 5.6.1 set_intersection](#5-6-1-set-intersection)
      2. [1.5.5.2. 5.6.2 set_union](#5-6-2-set-union)
      3. [1.5.5.3. 5.6.3 set_difference](#5-6-3-set-difference)**最新文章[C++面向对象编程](/2022/06/14/cpp-oop/)2022-06-14[职工管理系统](/2022/06/12/staff-management/)2022-06-12[机房预约系统](/2022/06/11/lab-reservation/)2022-06-11[c++提高编程](/2022/06/10/cpp-improved/)2022-06-10© 2025 By dre框架 [Hexo 8.0.0](https://hexo.io)|主题 [Butterfly 5.5.2](https://github.com/jerryc127/hexo-theme-butterfly)************